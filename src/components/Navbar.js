...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400 fixed w-full z-20 top-0 start-0 shadow-2xl border-b-4 border-white">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between p-3 mx-2">
        
        {/* Logo Section with Super Animation */}
        <motion.a
          href="/"
          className={`flex items-center space-x-2 transform transition-transform duration-1000 ${
        ...
        {/* User Profile Section - Super Enhanced */}
        {userProfile && (
          <motion.div
          ...
          >
            ...
            <div className="relative">
              ...
              >
                <motion.div 
                  className={`w-12 h-12 ${userProfile.avatar.color} rounded-full flex items-center justify-center border-2 border-white shadow-lg`}
                  animate={{
                    rotate: [0, 10, -10, 0],
                  }}
                  transition={{
                  ...
                  >
                    ...
                    <div className="p-6 bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 text-white relative overflow-hidden">
                      ...
                      <div className="flex items-center space-x-4 relative z-10">
                        <motion.div 
                          className={`w-16 h-16 ${userProfile.avatar.color} rounded-full flex items-center justify-center border-4 border-white shadow-lg`}
                          animate={{ rotate: [0, 360] }}
                          transition={{ duration: 4, repeat: Infinity }}
                        >
        ...
        {/* Navigation Links - Hidden on mobile for cleaner look */}
        <div
