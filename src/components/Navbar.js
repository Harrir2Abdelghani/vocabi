                      ...
                      <div className="relative p-4">
                        ...
                        <div className="space-y-2">
                          {gameCategories.map((game, index) => (
                            ...
                            >
                              <div
                                className={`flex items-center space-x-3 p-3 rounded-xl hover:bg-white/10 transition-all duration-300 border border-transparent hover:border-white/20`}
                              >
                                <div
                                  className={`w-10 h-10 bg-gradient-to-br ${game.color} rounded-lg flex items-center justify-center shadow-lg`}
                                >
                        ...
                        <div className="p-4 space-y-3">
                          <div className="grid grid-cols-3 gap-2">
                            ...
                            >
                              ...
                              <div
                                className={`font-black text-sm ${getScoreColor(userProfile.score)}`}
                              >
                                {userProfile.score.toLocaleString()}
                              </div>
