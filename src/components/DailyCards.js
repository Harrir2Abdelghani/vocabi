...
const AttentionGames = () => {
  return (
    <div id="familly-games" className="flex flex-col items-center p-6 bg-blue-200">
      <h2 className="text-3xl font-bold text-black mb-8 mt-4">Daily Activities Games</h2>
      ...
      <div className="relative rounded-lg overflow-hidden  transform hover:scale-105 transition-transform duration-300 h-[500px] w-80">
        ...
        <div className="relative flex items-center justify-center h-full">
          <img
            src={innerImage}
            alt="Inner Content"
            className="w-52 mt-14 h-96 object-contain z-20" // Adjust size and positioning as needed
          />
        </div>
      </div>
    </Link>
      ...
      <div className="relative rounded-lg overflow-hidden  transform hover:scale-105 transition-transform duration-300 h-[500px] w-80">
        ...
        <div className="relative flex items-center justify-center h-full">
          <img
            src={innerImage}
            alt="Inner Content"
            className="w-52 mt-14 h-96 object-contain z-20" 
          />
        </div>
      </div>
    </Link>
